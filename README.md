...
**Demo:** [Enola Self-Healing Stale Locks Recovery Demo](https://youtu.be/BoL6tvGxPEE)

**Watch the system tray clock on the taskbar in the video**

- The video pauses at 14:08:52 and resumes at 14:12:59. The pause is to allow 4 minutes to elapse before unlocking.
...
- Refer to the log file in the video for the exact lock and unlock times. Alternatively view the image at the end of this section to see the log file as created in the video.
