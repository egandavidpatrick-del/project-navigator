...
- The log file appears automatically in file explorer as generated by the Enola Service. Refer to the log file's Date Modified timestamp at the end of the video. This confirms that the lock and unlock operations were executed in real time.
