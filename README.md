...
- Refer to the log file in the video for the exact lock and unlock times. Alternatively view the image at the end of of this section to see the log file as created in the video.
