...
* [01. Architectural Diagram - Primary Unlocker Model](images/enola-server/image7.png)
* [02. Enola Backend MariaDB Database Monitor User Guide](guides/user-guides/PROJECT%20NAVIGATOR%20ENOLA%20USER%20GUIDE%20VERSION%201.0.pdf)
...
* [04. Project Navigator: Administrators User Guide](https://github.com/egandavidpatrick-del/project-navigator/blob/77947d43aff531b590bcd233c95f41533dbfff5d/guides/user-guides/PROJECT%20NAVIGATOR%20ADMINISTRATORS%20USER%20GUIDE%20VERSION%204.0.pdf)
...
* [07. Project Navigator: Messages User Guide](https://github.com/egandavidpatrick-del/project-navigator/blob/3b4b172b731013113db2c4bfb39fa2fb644d57b1/guides/user-guides/PROJECT%20NAVIGATOR%20MESSAGES%20USER%20GUIDE%20VERSION%204.0.pdf)
* [08. Project Navigator: MyProfile User Guide](https://github.com/egandavidpatrick-del/project-navigator/blob/3948cb021b144d4e2b33dab7215a1033936281f1/guides/user-guides/PROJECT%20NAVIGATOR%20MYPROFILE%20USER%20GUIDE%20VERSION%204.0.pdf)
* [09. Project Navigator: New User Registration User Guide](https://github.com/egandavidpatrick-del/project-navigator/blob/3948cb021b144d4e2b33dab7215a1033936281f1/guides/user-guides/PROJECT%20NAVIGATOR%20NEW%20USER%20REGISTRATION%20GUIDE%20VERSION%204.0.pdf)
* [10. Project Navigator: Operational User Guide](https://github.com/egandavidpatrick-del/project-navigator/blob/28af12ddd262b685e9c60cf05234570d4af6b809/guides/user-guides/PROJECT%20NAVIGATOR%20OPERATIONAL%20USER%20GUIDE%20VERSION%204.0.pdf)
* [11. Project Navigator: Record Locking User Guide](https://github.com/egandavidpatrick-del/project-navigator/blob/28af12ddd262b685e9c60cf05234570d4af6b809/guides/user-guides/PROJECT%20NAVIGATOR%20RECORD%20LOCKING%20USER%20GUIDE%20VERSION%204.0.pdf)

#  Multi-User Project Navigator

## Go to the table of contents below and click the Live Demo Link for demo videos.
## Go to the table of contents below and click the Enola Architecture Link for self-healing stale locks demo video.
...
* **Dependable:** Zero "calls home." No hidden telemetry, and no random updates breaking your pipeline.
...
| ------------------ | ------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Web UI             | AJAX / HTML / CSS / Bootstrap / JS / jQuery | Client-side presentation and asynchronous data fetching                                     |
...
**Demo:** [Enola Self-Healing Stale Locks Automatic Recovery Demo](https://youtu.be/1D1VnXFSG4o)

- The stale locks are gone. The Enola backend service removed them automatically with no IT intervention.
...
For a full breakdown of Enola and associated visible/hidden log files and PID naming check the Enola User Guide in the [ /guides/user-guides/PROJECT NAVIGATOR ENOLA USER GUIDE VERSION 1.0.pdf] folder in this repository.
...
The Project Navigator solves directory chaos by deploying an on-premises web and desktop hybrid platform that indexes legacy directories into a centralised database.
...
- <b>Instant Discovery vs. Manual Deep-Browsing:</b> Users query a central, catalogue via a web UI to locate project records across thousands of directories in seconds, completely eliminating manual path traversal.
- <b>Automated Concurrency Handling vs. Disconnected Work:</b> Traditional file browsing lacks record-level governance. The platform implements pessimistic record locking to prevent conflicting multi-user edits or deletes, keeping data safe during high-concurrency operations.
- <b>Self-Healing Infrastructure vs. IT Support Dependence:</b> If a traditional network file is left locked by an abandoned user session, it requires manual IT intervention. Navigator’s autonomous background service (Enola) evaluates and automatically flushes out stale locks after 5 minutes, ensuring 24/7/365 uptime without administrative overhead.
