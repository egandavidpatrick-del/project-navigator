...
- Refer to the log file in the video for the exact lock and unlock times.
  ...
  For a full breakdown of Enola's logs, including the visible/hidden files and PID naming check the Enola User Guide in the /guides folder in this repository.
---
